...
class Login:
    def __init__(self, root):
        ...
        self.bg = ImageTk.PhotoImage(
            file=r"C:\Users\Anish\Projects\Python_Test_Projects\Images_GUI\loginBg1.jpg")
        ...
        img1 = Image.open(
            r"C:\Users\Anish\Projects\Python_Test_Projects\Images_GUI\log1.png")
        ...
        # entry2
        self.txtpwd = ttk.Entry(frame1, font=(
    ...
    def login(self):
        if (self.txtuser.get() == "" or self.txtpwd.get() == ""):
            ...
            messagebox.showinfo(
                "Sussessfully", "Welcome to e-Attendance System Using Facial Recognition")
        else:
            # messagebox.showerror("Error","Please Check Username or Password !")
            conn = mysql.connector.connect(
                username='root', password='root', host='localhost', database='face_recognition', port=3307)
...
# This part is image labels setting start
        # first header image
        img = Image.open(
            r"C:\Users\Anish\Projects\Python_Test_Projects\Images_GUI\banner.jpg")
        ...
        # backgorund image
        bg1 = Image.open(
            r"C:\Users\Anish\Projects\Python_Test_Projects\Images_GUI\bg3.jpg")
        ...
        # title section
        title_lb1 = Label(bg_img, text="e-Attendance System Using Facial Recognition",
        ...
        std_img_btn = Image.open(
            r"C:\Users\Anish\Projects\Python_Test_Projects\Images_GUI\std1.jpg")
        ...
        det_img_btn = Image.open(
            r"C:\Users\Anish\Projects\Python_Test_Projects\Images_GUI\det1.jpg")
        ...
        att_img_btn = Image.open(
            r"C:\Users\Anish\Projects\Python_Test_Projects\Images_GUI\att.jpg")
        ...
        hlp_img_btn = Image.open(
            r"C:\Users\Anish\Projects\Python_Test_Projects\Images_GUI\hlp.jpg")
        hlp_img_btn = hlp_img_btn.resize((180, 180), Image.ANTIALIAS)
        self.hlp_img1 = ImageTk.PhotoImage(hlp_img_btn)

        hlp_b1 = Button(bg_img, image=self.hlp_img1,
        ...
        tra_img_btn = Image.open(
            r"C:\Users\Anish\Projects\Python_Test_Projects\Images_GUI\tra1.jpg")
        ...
        pho_img_btn = Image.open(
            r"C:\Users\Anish\Projects\Python_Test_Projects\Images_GUI\qr11.jpg")
        ...
        pho_b1_1 = Button(bg_img, command=self.open_img, text="Dataset", cursor="hand2", font=(
            "tahoma", 15, "bold"), bg="white", fg="navyblue")
        pho_b1_1.place(x=480, y=510, width=180, height=45)

        # Developers   button 7
        dev_img_btn = Image.open(
            r"C:\Users\Anish\Projects\Python_Test_Projects\Images_GUI\dev.jpg")
        dev_img_btn = dev_img_btn.resize((180, 180), Image.ANTIALIAS)
        self.dev_img1 = ImageTk.PhotoImage(dev_img_btn)

        dev_b1 = Button(bg_img, command=self.developr,
                        image=self.dev_img1, cursor="hand2", state=DISABLED)
        ...
        exi_img_btn = Image.open(
            r"C:\Users\Anish\Projects\Python_Test_Projects\Images_GUI\exi.jpg")
