...
# This part is image labels setting start
        ...
        std_img_btn = Image.open(
            r"C:\Users\Anish\Projects\Python_Test_Projects\Images_GUI\m.jpg")
        ...
        std_b1_1 = Button(bg_img, text="M.Mohsin", cursor="hand2", font=(
            "tahoma", 15, "bold"), bg="white", fg="navyblue")
        std_b1_1.place(x=250, y=380, width=180, height=45)

        # Detect Face  button 2
        det_img_btn = Image.open(
            r"C:\Users\Anish\Projects\Python_Test_Projects\Images_GUI\f.jpg")
        ...
        det_b1_1 = Button(bg_img, text="Faizan Tariq", cursor="hand2", font=(
            "tahoma", 15, "bold"), bg="white", fg="navyblue")
        det_b1_1.place(x=480, y=380, width=180, height=45)

        # Attendance System  button 3
        att_img_btn = Image.open(
            r"C:\Users\Anish\Projects\Python_Test_Projects\Images_GUI\w.jpg")
        ...
        att_b1_1 = Button(bg_img, text="M.Waseem", cursor="hand2", font=(
            "tahoma", 15, "bold"), bg="white", fg="navyblue")
        att_b1_1.place(x=710, y=380, width=180, height=45)

        # Help  Support  button 4
        hlp_img_btn = Image.open(
            r"C:\Users\Anish\Projects\Python_Test_Projects\Images_GUI\m1.png")
        ...
        hlp_b1_1 = Button(bg_img, text="Maria Khan", cursor="hand2", font=(
            "tahoma", 15, "bold"), bg="white", fg="navyblue")
